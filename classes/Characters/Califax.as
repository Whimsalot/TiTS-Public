package classes.Characters
{
	...
	public class Califax extends Creature
	{
		//constructor
		public function Califax()
		{
			...
			this.short = "Califax";
			this.originalRace = "Califax";
			this.a = "";
			this.capitalA = "";
			this.long = "Placeholder NPC based on Wetraxxel";
