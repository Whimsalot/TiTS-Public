package classes.Characters 
{
	 ...
	 */
	 ...
	 // Large female fighter, armed with large twohanded sword and throwing spears
	public class NyreanChampion extends Creature
	{
		...
		public function NyreanChampion() 
		{
			...
			this.meleeWeapon.shortName = "Greatsword";
			this.meleeWeapon.longName = "greatsword";
...
//			this.createPerk("Sneak Attack",0,0,0,0);
		...
		{
			return Math.floor(kGAMECLASS.chars["PC"].level * multiplier);
		}
